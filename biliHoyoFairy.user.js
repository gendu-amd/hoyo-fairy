...
(() => {
  ...
  (function() {
    ...
    const VIDEO_CARD_SELECTOR = [
      ...
      // 动态信息流（t.bilibili.com，选择器借鉴 bilibili-cleaner）
    ...
    const API = { view: /* @__PURE__ */ new Map(), tag: /* @__PURE__ */ new Map(), card: /* @__PURE__ */ new Map(), queue: [], active: 0, waiting: false, CONCURRENCY: 3, DELAY: 120 };
    function apiPump() {
